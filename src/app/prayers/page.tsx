...
export default function PrayersPage() {
  return <main className="prayers-page">
    ...
    <section className="prayer-feature-photo"><div><Image src="/images/faith-crosses.jpg" alt="Faith standing before crosses" fill sizes="(max-width: 720px) 88vw, 360px" priority /></div></section>
